function open_card () {
  ...
  //Angie making the CSS styling switch from 1 player to the other
  // const TURNBOXSELECT = document.querySelectorAll(".turn-box");
  
  
  
  // function turnBoxCSS(){
  //   if (currentPlayer === "x"){
  //       TURNBOXSELECT.classList.add(".turn-box-x");
  //   } 
    
  //   if (currentPlayer === "o") {
  //      TURNBOXSELECT.classList.toggle(".turn-box-o");
  //   }
  // }
  ...
  // 		beepOne.play();
  // 	});
  // const turnBox= document.querySelectorAll('.turn-box');
